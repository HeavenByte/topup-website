...
<head>
    ...
    <title>Log in - QuasarTopUp</title>
    ...
    <div class="min-h-screen flex items-center justify-center p-4 sm:p-8 relative z-10">
        ...
        <div class="flex w-full max-w-6xl bg-[#141519]/90 backdrop-blur-xl rounded-[2rem] overflow-hidden shadow-2xl border border-white/10">
            ...
            <div class="w-full lg:w-[55%] p-8 sm:p-12 lg:p-16 flex flex-col justify-between relative z-10">
                ...
                <!-- Header Text -->
                <div class="mb-10">
                    <p class="text-slate-400 text-[10px] font-bold tracking-widest uppercase mb-4">WELCOME BACK</p>
                    <h1 class="text-4xl sm:text-5xl font-bold text-white mb-4 tracking-tight">
                        Log in to account<span class="text-blue-500">.</span>
                    </h1>
                    <p class="text-slate-400 text-sm font-medium">
                        New here? <a href="{{ route('register') }}" class="text-blue-500 hover:text-blue-400 transition">Create an account</a>
                    </p>
                </div>
                ...
                <form method="POST" action="{{ route('login') }}" class="mt-2">
                    ...
                    <div class="space-y-5">
                        ...
                        <div class="relative group">
                            ...
                            <input type="email" name="email" :value="old('email')" class="w-full bg-[#1b1c21]/80 border border-white/5 rounded-xl px-4 py-3.5 text-sm text-slate-200 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors" placeholder="name@quasar.com" required autofocus autocomplete="username">
                        ...
                        <div class="relative group">
                            <div class="flex justify-between items-center mb-2 ml-1 pr-1">
                                <label class="block text-[10px] uppercase tracking-wider text-slate-500 font-bold">Password</label>
                                @if (Route::has('password.request'))
                                    <a href="{{ route('password.request') }}" class="text-[10px] font-bold text-blue-500 hover:text-blue-400 transition">Forgot Password?</a>
                                @endif
                            </div>
                            <input type="password" name="password" class="w-full bg-[#1b1c21]/80 border border-blue-500/40 rounded-xl px-4 py-3.5 text-sm text-slate-200 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors shadow-[0_0_15px_rgba(59,130,246,0.1)]" placeholder="••••••••" required autocomplete="current-password">
                        ...
                        <div class="ml-1 mt-2">
                            <label for="remember_me" class="inline-flex items-center cursor-pointer">
                                <input id="remember_me" type="checkbox" class="rounded border-white/10 bg-[#1b1c21] text-blue-500 shadow-sm focus:ring-blue-500 focus:ring-offset-[#141519] focus:ring-offset-2" name="remember">
                                <span class="ms-2 text-xs font-medium text-slate-400">Keep me logged in</span>
                            </label>
                        </div>
                    </div>
                ...
                <div class="relative my-8">
                    ...
                    <div class="relative flex justify-center text-[9px] uppercase font-bold tracking-widest">
                        <span class="px-4 bg-transparent text-slate-500 backdrop-blur-md">Or continue with</span>
                    </div>
                </div>
